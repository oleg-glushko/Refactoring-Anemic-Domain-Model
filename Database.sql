...
CREATE TABLE [dbo].[Customer](
	...
	[Status] [int] NOT NULL,
	[StatusExpirationDate] [datetime2] NULL,
...
GO
INSERT [dbo].[Customer] ([CustomerID], [Name], [Email], [Status], [StatusExpirationDate], [MoneySpent]) VALUES (2, N'Michal Samson', N'm.samson@yahoo.com', 2, CAST(N'2018-10-14 01:37:27.000' AS DateTime2), CAST(9.00 AS Decimal(18, 2)))
GO
...
GO
INSERT [dbo].[PurchasedMovie] ([PurchasedMovieID], [MovieID], [CustomerID], [Price], [PurchaseDate], [ExpirationDate]) VALUES (1, 1, 2, CAST(5.00 AS Decimal(18, 2)), CAST(N'2017-09-16 16:30:05.773' AS DateTime2), CAST(N'2017-09-18 00:00:00.000' AS DateTime2))
GO
INSERT [dbo].[PurchasedMovie] ([PurchasedMovieID], [MovieID], [CustomerID], [Price], [PurchaseDate], [ExpirationDate]) VALUES (2, 2, 2, CAST(4.00 AS Decimal(18, 2)), CAST(N'2017-09-15 15:30:05.773' AS DateTime2), NULL)
GO
INSERT [dbo].[PurchasedMovie] ([PurchasedMovieID], [MovieID], [CustomerID], [Price], [PurchaseDate], [ExpirationDate]) VALUES (3, 1, 1, CAST(4.00 AS Decimal(18, 2)), CAST(N'2017-10-15 13:26:19.000' AS DateTime2), CAST(N'2017-10-17 13:26:19.000' AS DateTime2))
GO
INSERT [dbo].[PurchasedMovie] ([PurchasedMovieID], [MovieID], [CustomerID], [Price], [PurchaseDate], [ExpirationDate]) VALUES (4, 1, 1, CAST(4.00 AS Decimal(18, 2)), CAST(N'2017-10-22 16:06:51.000' AS DateTime2), CAST(N'2017-10-24 16:06:51.000' AS DateTime2))
GO
